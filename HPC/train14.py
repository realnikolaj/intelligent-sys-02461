...
np.save("_all_37_accuracy_list",accuracy_list)
np.save("_all_37_loss_list",loss_list)    
...
fig.savefig('network_result14.png', transparent=False, dpi=80, bbox_inches="tight")
