...
np.save("_37_clean_accuracy_list",accuracy_list)
np.save("_37_clean_loss_list",loss_list)    
...
fig.savefig('network_result6.png', transparent=False, dpi=80, bbox_inches="tight")
