...
np.save("_35_clean_accuracy_list",accuracy_list)
np.save("_35_clean_loss_list",loss_list)    
...
fig.savefig('network_result2.png', transparent=False, dpi=80, bbox_inches="tight")
